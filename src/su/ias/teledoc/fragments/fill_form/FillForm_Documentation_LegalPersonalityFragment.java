...
public class FillForm_Documentation_LegalPersonalityFragment extends AbstractFillFormFragment implements IListener {
...
//    private TextView rulesTV;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        int resId = R.layout.fragment_documentation_fill_legal_personality;
        ...
        sendFilledFormBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (checkAnswers()) {
                    ...
                    new PostDataTask(FillForm_Documentation_LegalPersonalityFragment.this).execute(activity.getType(),
                                                    PostDataTask.STEP_1,
