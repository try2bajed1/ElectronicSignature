...
public class FillForm_ElectrSign_NaturalPerson_Fragment extends AbstractFillFormFragment implements IListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        int resId = R.layout.fragment_el_signautre_fill_natural_person;
        ...
        sendFilledFormBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (checkAnswers()) {
                    ...
                    new PostDataTask(FillForm_ElectrSign_NaturalPerson_Fragment.this).execute(activity.getType(),
                            PostDataTask.STEP_1,
