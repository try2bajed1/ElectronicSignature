...
public class FillForm_BankGuarantee_LegalPersonalityFragment extends AbstractFillFormFragment implements IListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        int resId = R.layout.fragment_bank_guarantee_fill_legal_personality;
        ...
        //todo: make updateFromShared method in parent class
...
//                    activity.setBuFaceInfoJson(getJsonForBusinessUnit());
                    ...
                    new PostDataTask(FillForm_BankGuarantee_LegalPersonalityFragment.this).execute(activity.getType(),
                                                    PostDataTask.STEP_1,
