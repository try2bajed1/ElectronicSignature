...
public class FillForm_PaymentService_SelfEmpoyedFragment extends AbstractFillFormFragment implements IListener {
...
*/
    ...
    private void saveToShared() {
        AppSingleton.getInstance().prefs.edit().putString(AbstractActivity.SHARED_USER_SURNAME, surnameET.getText().toString())
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        int resId = R.layout.fragment_payment_service_fill_self_employed;
        ...
        sendFilledFormBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (checkAnswers()) {
                    ...
                    new PostDataTask(FillForm_PaymentService_SelfEmpoyedFragment.this).execute(activity.getType(), PostDataTask.STEP_1, activity.getJsonForGetSmsCode(formattedPhoneStr).toString());
                } else {
